...
def main():
    ...
    print(os.getcwd())
    print(os.listdir())
    if os.path.isdir('/home/vineel/pypract/python_exercises/15modules/vvk'):
        os.rmdir('vvk')
    ...
    os.mkdir('vvk')
    print(os.listdir())
    k=os.path.isdir('/home/vineel/pypract/python_exercises/15modules/vvk')
    print(k)
    ...
    print(os.getpid())
    print(os.getgid())
    print(os.stat('/home/vineel/pypract/python_exercises/15modules/welcome.py'))
    print(os.path.getsize('/home/vineel/pypract/python_exercises/15modules/welcome.py'))
    ...
    if os.path.isdir('/home/vineel/pypract/python_exercises/15modules/hai'):
        os.rmdir('hai')
    print(os.makedirs("/home/vineel/pypract/python_exercises/15modules/hai"))
    print(os.listdir())
    print(os.removedirs("/home/vineel/pypract/python_exercises/15modules/hai"))
    print(os.listdir())
    print("***************SYS MODULE****************")
