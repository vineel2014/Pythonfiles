...
s.send("<-- Reciver`s Mobile Number -->"," <-- Message to Send -->") #calling methods in the class

s.sendLater("<-- Reciver`s Mobile Number -->"," <-- Message to Send -->","<-- Date(dd/mm/yyyy)-->","<-- Time(HH:MM) (24 Hour Format)-->")

print("Number of SMs sent today(WAY2SMS):",s.msgSentToday())
